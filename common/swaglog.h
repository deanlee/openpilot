...
#define LOGT(fmt, ...) cloudlog_t(CLOUDLOG_DEBUG, __FILE__, __LINE__, __func__, std::numeric_limits<uint32_t>::max(), fmt,  __VA_ARGS__)
#define LOGT_FRAME(frame, fmt, ...) cloudlog_t(CLOUDLOG_DEBUG, __FILE__, __LINE__, __func__, frame, fmt, __VA_ARGS__)
