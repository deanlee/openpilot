...
MultiCameraState::MultiCameraState(VisionIpcServer *v, cl_device_id device_id, cl_context ctx) {
  ...
  driver_cam.camera_init(this, v, driver_cam.camera_id, 20, device_id, ctx, VISION_STREAM_DRIVER);
  road_cam.camera_init(this, v, road_cam.camera_id, 20, device_id, ctx, VISION_STREAM_ROAD);
  wide_road_cam.camera_init(this, v, wide_road_cam.camera_id, 20, device_id, ctx, VISION_STREAM_WIDE_ROAD);
