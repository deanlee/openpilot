...
class ConfirmDialog(Widget):
  def __init__(self, text: str, confirm_text: str, cancel_text: str | None = None, rich: bool = False):
    ...
    self._label = Label(text, 70, FontWeight.BOLD, align=rl.GuiTextAlignment.TEXT_ALIGN_CENTER, valign=rl.GuiTextAlignmentVertical.TEXT_ALIGN_MIDDLE, color=rl.Color(201, 201, 201, 255))
