...
class Setup(Widget):
  def __init__(self):
    ...
    self._low_voltage_title_label = Label("WARNING: Low Voltage", TITLE_FONT_SIZE, FontWeight.MEDIUM, Align.LEFT,
                                          color=rl.Color(255, 89, 79, 255), padding=20)
    self._low_voltage_body_label = Label("Power your device in a car with a harness or proceed at your own risk.", BODY_FONT_SIZE,
                                         align=Align.LEFT, padding=20)
    ...
    self._getting_started_title_label = Label("Getting Started", TITLE_FONT_SIZE, FontWeight.BOLD, Align.LEFT, padding=20)
    self._getting_started_body_label = Label("Before we get on the road, let's finish installation and cover some details.",
                                             BODY_FONT_SIZE, align=Align.LEFT, padding=20)
    ...
    self._software_selection_title_label = Label("Choose Software to Use", TITLE_FONT_SIZE, FontWeight.BOLD, Align.LEFT, padding=20)
    ...
    self._download_failed_title_label = Label("Download Failed", TITLE_FONT_SIZE, FontWeight.BOLD, Align.LEFT, padding=20)
    self._download_failed_url_label = Label("", 52, FontWeight.NORMAL, Align.LEFT, padding=20)
    self._download_failed_body_label = Label("", BODY_FONT_SIZE, align=Align.LEFT, padding=20)
    ...
    self._network_setup_title_label = Label("Connect to Wi-Fi", TITLE_FONT_SIZE, FontWeight.BOLD, Align.LEFT, padding=20)
    ...
    self._custom_software_warning_title_label = Label("WARNING: Custom Software", 81, FontWeight.BOLD, Align.LEFT,
                                                      color=rl.Color(255, 89, 79, 255), padding=60)
    self._custom_software_warning_body_label = Label("Use caution when installing third-party software.\n\n"
                                                     ...
                                                     68, align=Align.LEFT, padding=60)
  ...
  def render_custom_software(self):
    ...
    gui_app.push_modal_overlay(self.keyboard, callback=handle_keyboard_result)
