...
public:
  ...
  inline int maxSeconds() const { return !segments_.empty() ? (segments_.rbegin()->first + 1) * 60 : 0; }
  inline int minSeconds() const { return !segments_.empty() ? segments_.begin()->first * 60 : 0; }
