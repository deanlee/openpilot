...
void MainWindow::createDockWidgets() {
  ...
  video_splitter->addWidget(controls_view = new ControlsView(this));
  ...
  QObject::connect(charts_widget, &ChartsWidget::zoomChanged, controls_view, &ControlsView::zoomChanged);
