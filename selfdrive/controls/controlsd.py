...
from openpilot.selfdrive.controls.constrols_events import ControlsEvent
...
class Controls:
  def __init__(self, CI=None):
    ...
    self.events = Events()
    self.controls_event = ControlsEvent()
  ...
  def update_events(self, CS):
    ...
    self.controls_event.update_device_events(self.sm, self.events)
    self.controls_event.update_peripheral_event(self.sm, self.events)
    self.controls_event.add_calibration_events(self.sm, self.events)
    self.controls_event.add_lane_change_events(self.sm, self.events, CS)
    self.controls_event.add_panda_events(self.sm, self.events, self)
    ...
    self.controls_event.add_manager_state_events(self.sm)
    ...
    if not (self.CP.notCar and self.joystick_mode):
      self.controls_event.add_location_event(self.sm, self.events)
