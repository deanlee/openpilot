...
class AlertRenderer(Widget):
  def __init__(self):
    ...
    self._full_text1_label = Label("", font_size=0, font_weight=FontWeight.BOLD, alignment=rl.GuiTextAlignment.TEXT_ALIGN_CENTER,
                                   alignment_vertical=rl.GuiTextAlignmentVertical.TEXT_ALIGN_TOP)
    self._full_text2_label = Label("", font_size=ALERT_FONT_BIG, alignment=rl.GuiTextAlignment.TEXT_ALIGN_CENTER,
                                   alignment_vertical=rl.GuiTextAlignmentVertical.TEXT_ALIGN_TOP)
