...
class DeviceInfoLayoutMici(Widget):
  def __init__(self):
    ...
    self._dongle_id_label = Label("device ID", 48, max_width=max_width, text_color=header_color, font_weight=FontWeight.DISPLAY)
    self._dongle_id_text_label = Label(params.get("DongleId") or 'N/A', 32, max_width=max_width, text_color=subheader_color, font_weight=FontWeight.ROMAN)

    self._serial_number_label = Label("serial", 48, text_color=header_color, font_weight=FontWeight.DISPLAY)
    self._serial_number_text_label = Label(params.get("HardwareSerial") or 'N/A', 32, max_width=max_width, text_color=subheader_color, font_weight=FontWeight.ROMAN)
